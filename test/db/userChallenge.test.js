...
describe('testing Userchallenge model', () => {
    beforeAll(async () => {
        ...
        await Userchallenge.create({html: 'TEXT', css: 'TEXT', js: 'TEXT', grade: 90, submited: true, imageId: 1});
    });
    afterAll(async () => {
        await db.close();
    });
    ...
    it('can create a userChallenge', async () => {
        await Userchallenge.create({html: 'TEXT1', css: 'TEXT1', js: 'TEXT1', grade: 0, submited: false, imageId: 2});
